...
let rec string_of_tip = function
  ...
  | TMul (t1,t2) -> "(" ^ string_of_tip t1 ^ " * " ^ string_of_tip t2 ^ ")"
...
let location = function
  | Int (_,l) | Float (_,l) | Bool (_,l) | Fst(_,l) | Snd(_,l)
  | Loc (_,l) | Ref (_,l) | Deref (_,l) | Atrib (_,_,l) | Pair(_,_,l)
  | Op (_, _, _,l)
...
let exps : expr -> expr list  = function
 ...
 | Var _ | Skip _ 
   -> []
 | Ref (e,_) | Deref (e,_) | Fun(_,_,e,_) | InjL (e,_,_) | InjR (e,_,_) | Fst(e,_) | Snd(e,_)
   -> [e]
