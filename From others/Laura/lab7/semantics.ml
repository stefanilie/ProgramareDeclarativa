...
let rec reduce = function
  ...
  | (Op(Int (n1,_),Inm,Int(n2,_),loc),s) -> Some (Int (n1*n2,loc),s)    (*Op**)
  | (Op(Int (n1,_),Imp,Int(n2,_),loc),s) -> Some (Int (n1/n2,loc),s)    (*Op/*)
  | (Op(Int (n1,_),Sc,Int(n2,_),loc),s) -> Some (Int (n1-n2,loc),s)       (*Op-*)
  ...
  | (If(e,e1,e2,loc),s) ->                                             (*IfS*)
    (match reduce (e,s) with Some (e',s') -> Some (If(e',e1,e2,loc),s')
      | None -> None)
  | (While(e1,e2,loc),s) -> Some (If(e1,Secv(e2,While(e1,e2,loc),loc),Skip loc,loc),s) (*While*)      (*default*)
  | (For(e1,e2,e3,e4,loc),s) -> Some (Secv(e1,If(e2,Secv(e4,Secv(e3,For(Skip loc,e2,e3,e4,loc),loc),loc),Skip loc, loc),loc),s)   (*For*)
  | _ -> None 
