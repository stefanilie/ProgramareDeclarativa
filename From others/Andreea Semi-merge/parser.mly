...
expr:
  ...
  */
  ...
  | LET VAR EQ expr IN expr %prec FUNX
                               { Let ($2, $4, $6, location()) }
  | LAC VAR EQ expr SEQ VAR EQ expr SEQ RAC  {Rec ($2, $4, $6, $8, location())}   /*record*/  /*ADAUGAT*/
  |LPAREN expr VRG expr VRG expr RPAREN {Foldleft ($2,$4,$6,location())}  /*foldleft*/      /*here*/
...
funexpr:
  ...
  | LPAREN expr COM expr RPAREN { Pair($2,$4,location()) }    
;
