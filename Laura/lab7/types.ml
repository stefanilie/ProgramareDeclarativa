...
let rec infertype m = function
  ...
  | Op(e1,Mic,e2,_) -> (match (infertype m e1, infertype m e2) with
     ...
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  | Op(e1,Inm,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  | Op(e1,Imp,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  | Op(e1,Sc,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  ...
  | For (e1,e2,e3,e4,_) -> (match (infertype m e1, infertype m e2, infertype m e3, infertype m e4) with
     | (TUnit, TBool, TUnit, TUnit) -> TUnit
     | (TUnit, TBool, TUnit, t) -> raise (TypeError (e4, TUnit, t))
	 | (TUnit,TBool,t,_) -> raise (TypeError (e3, TUnit, t)))
	 | (TUnit,t,_,_) -> raise (TypeError (e2, TBool, t)))
	 | (t,_,_,_) -> raise (TypeError (e1, TUnit, t)))
